...
describe('@integration: Account Transactions', () => {
  ...
  const votes = [{
    username: 'phaetonpool_com_01',
    address: '14593474056247442712P',
  ...
  beforeEach(() => {
    ...
    const transactionExample = {
      senderId: '456P', receiverId: '456P', type: txTypes.send, id: '123456',
    };
  ...
  const setupStep = ({ accountType, address }, accountExtraProps = {}) => {
    ...
    accountAPIStub.withArgs(match.any, '123P')
  ...
  describe('Scenario: should allow to view transactions details of any account', () => {
    step('Given I\'m on "accounts/123L" as "genesis" account', () => setupStep({ accountType: 'genesis', address: '123P' }));
    step('Then I should see 20 transaction rows as result of the address 123P', () => helper.shouldSeeCountInstancesOf(20, 'TransactionRow'));
    step('When I click on a transaction row', () => helper.clickOnElement('.transactions-row'));
    step('Then I should be redirected to transactoinDetails step', () => helper.checkRedirectionToDetails('123P', '123456'));
  });

  describe('Scenario: should allow to filter transactions', () => {
    step('Given I\'m on "wallet" as "genesis" account', () => setupStep({ accountType: 'genesis', address: '123P' }));
  ...
  describe('Scenario: allows to view transactions without login', () => {
    step('Given I\'m on "accounts/123L" with no account', () => setupStep({ address: '123P' }));
    step('Then I should see 20 transaction rows as result of the address 123P', () => helper.shouldSeeCountInstancesOf(20, 'TransactionRow'));
  });
  ...
  describe('Scenario: allows to load more cache transactions of an account', () => {
    ...
    step('Then I should see 40 transaction rows as result of the address 123P', () => helper.shouldSeeCountInstancesOf(40, 'TransactionRow'));
  });
