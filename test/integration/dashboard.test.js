...
import phaetonServiceReducer from '../../src/store/reducers/phaetonService';
...
describe('@integration: Dashboard', () => {
  ...
  beforeEach(() => {
    ...
    phaetonServiceAPIStub = stub(phaetonServiceAPI, 'getCurrencyGraphData');
  ...
  const setupStep = (accountType, options = { isLocked: false }) => {
    ...
    phaetonServiceAPIStub.withArgs(match.any).returnsPromise()
      .resolves({
        body: {
