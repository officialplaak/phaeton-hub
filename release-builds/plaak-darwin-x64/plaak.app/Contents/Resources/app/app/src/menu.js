...
const addAboutMenuForNonMac = ({ template, electron }) => {
  const copyright = `Copyright © 2016 - ${new Date().getFullYear()} Phaeton Foundation`;
  ...
  buildTemplate: electron =>
    ([
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n.t('Phaeton Help Center'),
            click: menu.onClickLink.bind(null, electron, 'https://help.phaeton.io/'),
          },
          {
          ...
          {
            label: i18n.t('Phaeton Chat'),
            click: menu.onClickLink.bind(null, electron, 'https://phaeton.chat'),
          },
          {
          ...
          },
          {
            ...
            click: menu.onClickLink.bind(null, electron, 'https://phaeton.io/academy'),
          },
          {
            type: 'separator',
          },
          {
            ...
            click: menu.onClickLink.bind(null, electron, 'https://bitbucket.org/anoopsam/plaak_hub/releases'),
          },
        ],
      },
    ]),
