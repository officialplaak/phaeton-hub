...
describe('DelegateList', () => {
  const delegate1 = {
    publicKey: 'sample_key_1', account: { address: '100001P' }, rank: 1, productivity: 99,
  };
  const delegate2 = {
    publicKey: 'sample_key_2', account: { address: '100002P' }, rank: 2, productivity: 98,
  };
  const delegate3 = {
    publicKey: 'sample_key_3', account: { address: '100003P' }, rank: 3, productivity: 97,
  };
  const props = {
