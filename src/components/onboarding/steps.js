...
export const steps = t => ([
  ...
  {
    title: t('Welcome to Phaeton Hub'),
  ...
  // your Phaeton ID will be locked to prevent an unauthorized use of your Phaeton ID. .
  ...
  },
  {
    ...
    text: t('Click here to go to the main page of Phaeton Hub and find all relevant statistics and ID information'),
    selector: '#dashboard',
    position: 'right',
    style: styles.step,
  },
  {
    title: t('Send LSK'),
    text: t('Click here to transfer funds between Phaeton IDs and access your transaction history.'),
