...
class Voting extends React.Component {
  ...
  render() {
    return (
      <div className={`${grid.row} ${styles.wrapper} voting_wrapper delegates_wrapper`} ref={(el) => { this.root = el; }}>
        ...
        <section id="walletdiv" className={`${grid['col-sm-12']} ${grid['col-md-8']} ${styles.votingBox} ${styles.votes}`}>
