...
class SecondPassphrase extends React.Component {
  ...
  render() {
    ...
    const header = t('Secure the use of your Phaeton ID with a second passphrase.');
    const message = t('You will need it to use your Phaeton ID, like sending and voting. You are responsible for keeping your second passphrase safe. No one can restore it, not even Phaeton.');
