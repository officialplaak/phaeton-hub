      ...
      <div className={`${styles.wrapper} send`}>
        <div className={styles.header}>
          <header className={styles.headerWrapper}>
            <h2>{this.props.accountInit ? this.props.t('Initialize Phaeton ID') : this.props.t('Confirm transfer')}</h2>
          </header>
        ...
        {this.props.accountInit
          ? <div>
            ...
            <p>{this.props.t('You only need to do this once for each Phaeton ID.')}</p>
          </div>
          : <form>
