          ...
          <div className={stepStyles.container}>
            <div className={stepStyles.firstContainer}>
              ...
              <p className={stepStyles.description}>
                {t('Delegates have great responsibility within the Phaeton system, securing the blockchain. Becoming a delegate requires the registration of a name. The top 101 delegates are eligible to forge.')}
              </p>
            </div>
