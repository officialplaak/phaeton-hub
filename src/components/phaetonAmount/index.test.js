...
import PhaetonAmount from './';

describe('PhaetonAmount', () => {
  ...
  it('should normalize "12932689.645" as "12,932,689.645"', () => {
    ...
    const wrapper = mount(<PhaetonAmount val={inputValue} />, {
      context: { i18n },
      childContextTypes: {
  ...
  it('should round to props.roundTo decimal places', () => {
    ...
    const wrapper = mount(<PhaetonAmount val={inputValue} roundTo={2} />, {
      context: { i18n },
      childContextTypes: {
        i18n: PropTypes.object.isRequired,
      },
