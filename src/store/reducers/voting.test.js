...
describe('Reducer: voting(state, action)', () => {
  ...
  const delegate1 = {
    publicKey: 'sample_key_1', address: '100001P', rank: 1, productivity: 99,
  };
  const delegate2 = {
    publicKey: 'sample_key_2', address: '100002P', rank: 2, productivity: 98,
  };
  const delegate3 = {
    publicKey: 'sample_key_3', address: '100003P', rank: 3, productivity: 97,
  };
  const delegate4 = {
    publicKey: 'sample_key_4', address: '100004P', rank: 4, productivity: 96,
  };
  const delegate5 = {
    publicKey: 'sample_key_5', address: '100005P', rank: 5, productivity: 95,
  };
  const cleanVotes = {
